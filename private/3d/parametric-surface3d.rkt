...
(define surface3d? surface3d-value?)
(define surface3d-grid surface3d-value-grid)
(define surface3d-normals surface3d-value-normals)
(define surface3d-unresolved-normal-indices surface3d-value-unresolved-normal-indices)
(define surface3d-colors surface3d-value-colors)
(define surface3d-material surface3d-value-material)
...
(define (surface3d-u-range surface)
  (surface-range surface surface-grid-u-values 'surface3d-u-range))
...
(define (surface3d-v-range surface)
  (surface-range surface surface-grid-v-values 'surface3d-v-range))
...
(define (surface3d-with-colors surface colors)
  ...
  (struct-copy surface3d-value surface
               [colors (check-colors 'surface3d-with-colors colors
...
(define (surface-scalar-field surface accessor)
  ...
  (define data (surface3d-value-scalar-data surface))
