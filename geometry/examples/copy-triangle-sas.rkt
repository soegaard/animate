...
(construction copy-triangle-sas
  ...
  (layout (focus A B C O B2 C2)
          ...
          (label-side O 'below-left) (label-side B2 'below-right) (label-side C2 'above))
  ...
  (step "Join the three new vertices."
    [A2C2 (segment O C2)] [B2C2 (segment B2 C2)])
  (step "Two sides and their included angle match the source triangle."
    ...
    (hide target r2))
  (step #:pause 1.5 "The triangles are congruent by SAS." (highlight A2B2 A2C2 B2C2))
