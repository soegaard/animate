...
(construction circumcenter
  ...
  (layout (focus A B C O) (label-side O 'below-right))
  ...
  (step "Construct the perpendicular bisector of AB."
    (expand [m (c:perpendicular-bisector A B)] #:auxiliaries 'hide))
  ...
  (step "The circle centred at O through A also passes through B and C."
...
(define (make-demo-timeline #:aspect [aspect 16/9] #:theme-mode [mode 'light])
  (construction->timeline circumcenter #:aspect aspect #:theme (make-library-theme mode)))
