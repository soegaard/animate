...
(define selectors '(stroke fill label point line segment ray circle semantic-label point-label segment-label length-label angle-label compass-guide compass-attention marker right-angle-marker length-marker parallel-marker angle-marker normal deemphasized highlighted))
(define states '(normal deemphasized highlighted))
(define (selector-path? path)
  (define kinds '(point line segment ray circle semantic-label point-label segment-label length-label angle-label compass-guide compass-attention marker right-angle-marker length-marker parallel-marker angle-marker))
  ...
  (geometry-theme-value
   (compile-rules
    '((stroke (width 2))
      ...
      (compass-guide (opacity 1) (stroke (width 2.5) (dash solid) (color highlight)))
      (compass-attention (opacity 0.45) (stroke (width 9) (dash solid) (color highlight)))
