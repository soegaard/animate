...
(module+ test
  (define arrow (arrow3d origin3 (vec3 0 0 2) #:id 'arrow
                         #:shaft-style (stroke3d #:width 3)))
  ...
  (check-true (spatial-visual? (second (group3d-children arrow))))
  ...
  (check-true (spatial-visual? (point3d origin3 #:id 'point)))
  (check-exn exn:fail?
