...
(module+ test
  ...
  (check-not-eq? (module-binding "../slides.rkt" 'slide?) absent)
  (check-not-eq? (module-binding "../slides.rkt" 'make-slide) absent)
  (check-not-eq? (module-binding "../slides/pict.rkt" 'slide->pict) absent)
  (check-not-eq? (module-binding "../slides/scene.rkt" 'slide->scene) absent)
