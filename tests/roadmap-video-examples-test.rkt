  ...
  (for ([example-and-labels
         (in-list
          (list (cons "generic-interpolable-values.rkt" '(title))
                ...
                (cons "stagger-map.rkt" '(title note))
                (cons "enter-leave-effects.rkt" '(title note))
                (cons "progressive-reveals.rkt" '(title note))
                (cons "clip-reveals.rkt" '(title note))
                (cons "transient-effects.rkt" '(title note))
                (cons "ripple-effects.rkt" '(title note))
                (cons "wave-effects.rkt" '(title note))
                (cons "deterministic-camera-shake.rkt" '(title note))
                (cons "deterministic-confetti.rkt" '(title note))
                (cons "typewriter-and-decorations.rkt" '(title note))
                (cons "effect-composition-stress.rkt" '(title note))))])
