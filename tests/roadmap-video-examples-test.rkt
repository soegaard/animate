  ...
  (for ([example-and-labels
         (in-list
          (list (cons "generic-interpolable-values.rkt" '(title))
                ...
                (cons "source-addressable-formulas.rkt" '(title source))
                (cons "transform-matching-strings.rkt" '(title explanation))
                (cons "string-matched-derivation.rkt" '(title instructions))
                ...
                (cons "semantic-nested-affine-transforms.rkt" '(title explanation))
                (cons "serializable-rate-functions.rkt" '(title explanation))
                ...
                (cons "probability-and-statistics.rkt" '(title explanation))
                (cons "layout-finishing.rkt" '(title explanation))
                (cons "relation-visuals.rkt" '(title note))))])
