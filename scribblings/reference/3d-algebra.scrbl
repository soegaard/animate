...
This first topology layer is intentionally triangle-based: it does not yet
combine coplanar triangles into polygonal mathematical faces, repair malformed
input, or turn a branching boundary graph into a fictitious loop. Those are
separate U-stage operations.
